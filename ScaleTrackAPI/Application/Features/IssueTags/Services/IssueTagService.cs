...
using ScaleTrackAPI.Application.Features.IssueTags.Mappers.IssueTagMapper;
...
namespace ScaleTrackAPI.Application.Features.IssueTags.Services.IssueTagService
{
