...
namespace ScaleTrackAPI.Application.Features.Auth.ResendVerification.BusinessRules
{
    public class ResendVerificationBusinessRules
    {
        private readonly IUserRepository _userRepo;
        private readonly EmailHelper _emailHelper;


        public ResendVerificationBusinessRules(IUserRepository userRepo, EmailHelper emailHelper)
        {
            _userRepo = userRepo;
